...
export const mdxComponents = {
  ...
  img: ({ className, alt, ...props }: React.ComponentProps<"img">) => (
    // biome-ignore lint/performance/noImgElement: MDX content images don't have predefined dimensions
    // biome-ignore lint/correctness/useImageSize: MDX content images don't have predefined dimensions
