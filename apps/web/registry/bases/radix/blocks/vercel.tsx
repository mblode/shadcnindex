...
function UsageCard() {
  return (
    <Example className="items-center" title="Usage">
            ...
            {items.map((item) => (
              ...
              >
                <a href="#">
                  ...
                  <ItemActions>
                    <span className="font-medium font-mono text-muted-foreground text-xs tabular-nums">
                      {item.value}
                    </span>
                  </ItemActions>
                </a>
...
function AnomalyAlert() {
  return (
    <Example className="items-center justify-center" title="Anomaly Alert">
...
function DeploymentFilter() {
  ...
  return (
    <Example containerClassName="col-span-full" title="Deployment Filter">
...
function ActivateAgentDialog() {
  return (
    <Example className="items-center justify-center" title="Activate Agent">
      <Dialog>
...
function ObservabilityCard() {
  return (
    <Example className="items-center justify-center" title="Observability">
...
function FeedbackForm() {
  return (
    <Example className="items-center justify-center" title="Feedback Form">
...
function AnalyticsCard() {
  return (
    <Example className="justify-center" title="Analytics Card">
