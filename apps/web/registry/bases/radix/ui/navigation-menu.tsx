  ...
  return (
    ...
    >
      <NavigationMenuPrimitive.Viewport
        className={cn(
          "cn-navigation-menu-viewport relative mt-1.5 h-[var(--radix-navigation-menu-viewport-height)] w-full origin-top-center overflow-hidden md:w-[var(--radix-navigation-menu-viewport-width)]",
          className
        )}
